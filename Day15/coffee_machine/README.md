...
- The program can be executed in the <em>main.py</em> file, which executes the main program function, which can be found under the *src* folder, in the *coffee_machine.py* file.
